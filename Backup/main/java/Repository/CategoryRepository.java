...
public class CategoryRepository extends DBRepository<Category> {
    ...
    public CategoryRepository(Validator validator, Long disciplina, Properties props) {
    ...
    @Override
    public Category save(Category entity) throws ValidationException, IllegalArgumentException, SQLException {
    ...
    @Override
    public Category update(Category entity) throws IllegalArgumentException, ValidationException, SQLException {
